...
const s = StyleSheet.create({
  ...
  input: { backgroundColor: theme.colors.surface, borderWidth: 1, borderColor: theme.colors.ink200, borderRadius: theme.radius.md, paddingHorizontal: 12, paddingVertical: 10, fontSize: 15, color: theme.colors.ink900 },
  row2: { flexDirection: "row", gap: 12 },
  wrap: { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  pill: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: theme.radius.full, borderWidth: 1, borderColor: theme.colors.ink200, backgroundColor: theme.colors.surface },
  ...
  setInput: { backgroundColor: theme.colors.ink50, borderWidth: 1, borderColor: theme.colors.ink200, borderRadius: theme.radius.sm, paddingHorizontal: 8, paddingVertical: 8, textAlign: "center", color: theme.colors.ink900 },
  checkRow: { flexDirection: "row", alignItems: "center", gap: 10, marginTop: 16, backgroundColor: theme.colors.ink50, padding: 12, borderRadius: theme.radius.md },
  ...
  footer: { position: "absolute", bottom: 0, left: 0, right: 0, padding: 16, backgroundColor: theme.colors.surface, borderTopWidth: 1, borderTopColor: theme.colors.ink100 },
  saveBtn: { backgroundColor: theme.colors.brand, borderRadius: theme.radius.md, paddingVertical: 15, alignItems: "center" },
