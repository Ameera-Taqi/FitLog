...
export const ORDER_STATUS_BADGE: Record<PaymentStatus, string> = {
  ...
  refunded: "bg-violet-500/15 text-violet-600 ring-violet-500/40",
};

export const ORDER_STATUSES: PaymentStatus[] = ["pending", "awaiting_payment", "paid", "failed", "expired", "refunded"];
